import sys
sys.path.append("../Skip_Gram_NEG")

import torch.optim as optim
from skip_gram_neg_model import SkipGramNEGModel
...
class Word2Vec(object):
    def __init__(self, input_file_name, output_file_name):
        ...
        self.model = SkipGramNEGModel(self.data.word_count, EMB_DIMENSION)
    ...
    def train(self):
        ...
        for _ in process_bar:
            ...
            pos_w = [int(pair[0]) for pair in pos_pair]
